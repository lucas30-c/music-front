...
class BookingEventEdit extends Component {
  ...
  componentDidMount() {
    ...
    this.setState({
      ...
      selectedTimes:[moment(_this.props.rowData.startTime, 'YYYY-MM-DD HH:mm:ss'),moment(_this.props.rowData.endTime, 'YYYY-MM-DD HH:mm:ss')],
      user_booking_event: rowData.userBookingEvent
    },()=>{
  ...
  handleSubmit() {
    ...
    let user_booking_event_id = this.state.user_booking_event.id;
    let capacity = this.state.user_booking_event.number;
    console.log("user_id:" + user_id);
    console.log("event_id:" + event_id);
    console.log("venue_id:" + venue_id);
    console.log("venue_section_id:" + venue_section_id);
    console.log("user_booking_event_id:" + user_booking_event_id);
    // console.log(this.state.user_booking_event);
    ...
    // 进行其他处理或者发起登录请求
      $.ajax({
        ...
        data: {
          ...
          user_booking_event_id: user_booking_event_id,
          capacity: capacity
        },
